...
class StatusPage extends StatefulWidget {
  final String accessToken; // Tambahkan properti accessToken

  StatusPage({Key? key, required this.accessToken}) : super(key: key);
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (BuildContext context) => CartScreen(cartItems: [], accessToken: widget.accessToken),
                    ),
                  );
                },
                style: ButtonStyle(
